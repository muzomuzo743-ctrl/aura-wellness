<footer class="footer">
    <div class="container footer-container">
        ...
        <div class="footer-links">
            <h4>Hızlı Linkler</h4>
            <ul>
                <li><a href="index.php#home">Anasayfa</a></li>
                <li><a href="index.php#about">Hakkımızda</a></li>
                <li><a href="index.php#services">Hizmetlerimiz</a></li>
                <li><a href="page-terapistler.php">Terapistlerimiz</a></li>
            </ul>
        </div>
        <div class="footer-newsletter">
            ...
            <a href="page-terapistler.php" class="btn btn-primary footer-btn">
...
<a href="page-terapistler.php" class="floating-whatsapp" aria-label="Terapistlerimiz Sayfası">
